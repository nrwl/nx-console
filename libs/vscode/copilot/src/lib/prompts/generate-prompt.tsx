    ...
    return (
      <>
        <SystemMessage priority={100}>
          ...
          development. You have access to the project graph and schemas for
          running nx generators. Use the user prompt to create a generator
          invocation and return a cli command to run the generator. Always
          finish the response with an nx generator invocation like "nx generate
          ...". Use the full string '${this.props.packageManagerExecCommand}'
          and wrap the invocation in """ to be parsed reliably. DO NOT RENDER
          THE CLI COMMAND IN \`\`\` OR A CODE BLOCK.
        </SystemMessage>
        <History
