...
export class CIPETreeItem extends BaseRecentCIPETreeItem implements CIPETreeItemInterface, Disposable {
  type = 'CIPE' as const;
...
export class RunGroupTreeItem extends BaseRecentCIPETreeItem implements RunGroupTreeItemInterface {
...
export class RunTreeItem extends BaseRecentCIPETreeItem implements RunTreeItemInterface {
  type = 'run' as const;
...
export class FailedTaskTreeItem extends BaseRecentCIPETreeItem implements FailedTaskTreeItemInterface {
