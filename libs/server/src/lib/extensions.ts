...
export const EXTENSIONS: { [key: string]: string } = {
  ...
  '@dnation/web3':
    'A schematics for build decentralised application with Angular and web3',
  ...
  '@syncfusion/ej2-angular-inplace-editor':
    'A package of Essential JS 2 Inplace editor components, which is used to edit and update the value dynamically in server. for Angular',
  ...
  '@syncfusion/ej2-angular-lineargauge':
    'Essential JS 2 LinearGauge Components for Angular',
  ...
  '@syncfusion/ej2-angular-maps':
    'The Maps component is used to visualize the geographical data and represent the statistical data of a particular geographical area on earth with user interactivity, and provides various customizing options for Angular',
  ...
  '@syncfusion/ej2-angular-treemap':
    'Essential JS 2 TreeMap Components for Angular',
  ...
  'ngx-semantic-version': 'Add and configure commitlint, commitizen, husky and standard-version for creating conventional commits and automate your release and CHANGELOG generation respecting semver',
...
export function availableExtensions(): Array<{
  name: string;
  description: string;
}> {
