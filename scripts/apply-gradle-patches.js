...
const gradlePackagePath = path.join(__dirname, '..', 'node_modules', '@nx', 'gradle');
...
if (patchedFiles > 0) {
  console.log('🚀 Gradle logging patches applied successfully! CI will now show comprehensive logs.');
